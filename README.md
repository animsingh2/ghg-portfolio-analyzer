...
A Python library for calculating financed emissions across investment portfolios, built to the PCAF Global GHG Accounting and Reporting Standard (2022).
What it does
...
Quickstart
pythonfrom loader import load_portfolio_csv, load_emissions_csv
